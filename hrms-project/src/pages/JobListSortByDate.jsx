...
export default function JobListSortByDate() {
    const [jobPostings, setjobPostings] = useState([])

    useEffect(() => {
        let jobPostingService = new JobPostingService()
        jobPostingService.getAllActiveJobPostingsSortByDate().then(result => setjobPostings(result.data))
    }, [])


    return (
        <div>
            <Button as={NavLink} to="/">Rastgele Sırala</Button>
            <Table celled>
                <Table.Header>
                    <Table.Row>
